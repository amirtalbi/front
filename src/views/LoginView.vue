<template>
  <div class="flex justify-center items-center ">
    <form class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 bg-white p-8 shadow-md rounded">
      ...
      <div class="flex justify-center">
        <button @click="login" type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Se connecter</button>
    </div>
...
export default {
  ...
  methods:{
    login(){
      const res=this.$store.dispatch('users/login', {numero_etudiant:this.numero_etudiant,password:this.password})
      console.log(res)
    }
  },
  async mounted(){
